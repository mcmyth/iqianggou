...
function AddItem()
{
    ...
    {
    var count=20;
    if(src["data"].length<count) count = src["data"].length ;
 ...
 left = 0;
	...
	}else
	{
		      ...
		      document.getElementById('container').innerHTML='<p style="text-align: center;">没有搜索到任何商品.</p>';
	}
        ...
        $.ajax({
            ...
            success: function(data) {
             ...
             aa=data;
                ...
                try {freeze_period="<li>每人"+data["data"]["freeze_period"][3]["text"]+"天限购一次</li>"}catch(err) {}
