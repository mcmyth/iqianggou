...
<head>
    ...
    <link rel="stylesheet" href="plugin/zoomify.min.css">
    <meta charset="UTF-8">
...
<body onload="start();">
<div id="allmap"></div>
<div id="header"><div id="title">爱抢购<div id="hide_item_container"><input onclick="hideItem()" id="hide_item" name="hide_item" type="checkbox" value="" /><label for="hide_item">隐藏抢光</label></div></div><div id="location" onclick="edit(this);">获取位置中...</div></div>
<!--<button onclick="GetItem()">Deubg</button>-->
 <div class="search_container">
<div class="search d2">
            <div class="search_button_container">
                <input id="search_input" type="text" name="search" onkeypress="if(event.keyCode==13) search();" placeholder="搜索...">
...
<div class="item" id="loading_container">
    ...
    <details class="loading"  onclick="return false;">
...
<script src="plugin/zoomify.min.js"></script>
